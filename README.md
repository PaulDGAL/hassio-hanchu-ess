...
1. Download or clone this repository:
   ...
   ```
2. Copy the `custom_components/hanchu-ess` folder into your Home Assistant `config` directory so the path becomes:
   ```
   <config>/custom_components/hanchu-ess/
   ```
...
```
custom_components/hanchu-ess/   Integration source files
