...
class TestScaffold(unittest.TestCase):
    ...
    def test_core_files_exist(self) -> None:
        expected = [
            "custom_components/hanchu/__init__.py",
            "custom_components/hanchu/config_flow.py",
            "custom_components/hanchu/const.py",
            "custom_components/hanchu/coordinator.py",
            "custom_components/hanchu/manifest.json",
            "custom_components/hanchu/strings.json",
            "custom_components/hanchu/translations/en.json",
        ]
